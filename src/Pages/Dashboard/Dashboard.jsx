...
const Dashboard = () => {
  ...
  const {userType,currentUser} = useContext(AuthUserRoleContext)
  const selectedRole = localStorage.getItem(`${currentUser?.uid}`);
  ...
  return (
    <div>
      ...
      <div className="flex h-screen">
        <div className={`menu focus:text-indigo-100 ${showText ? "w-80 absolute" : "w-fit relative"} md:relative z-[9] text-base-content h-screen bg-base-100 border-r-[0.5px]`}>
